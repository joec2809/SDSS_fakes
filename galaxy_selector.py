...
qbs_cond = "WHERE lin_con_pEQW_Halpha > -3 AND 4 > (Lick_HDelta_Index - Lick_HDelta_Index_Err > 1.31)"
quiscent_cond = "WHERE lin_con_pEQW_Halpha > -3 AND 4 > (Lick_HDelta_Index - Lick_HDelta_Index_Err < 1.31)"
